-- CreateEnum
CREATE TYPE "MessageType" AS ENUM ('CHAT', 'DAILY_REPORT', 'FEEDBACK');
...
CREATE TABLE "Message" (
    ...
    "messageType" "MessageType" NOT NULL DEFAULT 'CHAT',
    "parentId" TEXT,
...
-- AddForeignKey
ALTER TABLE "Thread" ADD CONSTRAINT "Thread_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
